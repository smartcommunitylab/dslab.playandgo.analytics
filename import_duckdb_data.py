...
def import_duckdb_data(territory_id:str, filter_campaign_id:str=None):
    ...
    for _, row in df_campaigns.iterrows():
        ...
        logging.info(f"import_duckdb_data for territory '{territory_id}' campaign '{campaign_id}' and years {years}.")
        ...
        duck_engine.close()
        logging.info(f"import_duckdb_data for territory '{territory_id}' campaign '{campaign_id}' and years {years}. done")
